...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `35.4µs` | `38.0µs` |
| [Day 2](./src/bin/02.rs) | `220.7µs` | `186.9µs` |
| [Day 3](./src/bin/03.rs) | `34.9µs` | `29.8µs` |
| [Day 4](./src/bin/04.rs) | `83.0µs` | `40.5µs` |
| [Day 5](./src/bin/05.rs) | `828.0µs` | `901.2µs` |
